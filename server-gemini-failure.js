...
// Modify generate-all-images route to use the correct configuration
app.post('/generate-all-images', async (req, res) => {
    const { sections } = req.body;

    try {
        // Previous context analysis code remains the same...
...
initializeApp(); // Call initialize app to run setup before starting server